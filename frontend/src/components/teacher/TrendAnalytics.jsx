...
const TrendAnalytics = ({ data = [] }) => {
  // Using data prop to determine if we have enough data. 
  // In a real scenario, this would aggregate `data` by month.
  ...
  return (
    <div className="teacher-panel-container">
      ...
      {!hasData ? (
        <div style={{ padding: '3rem', textAlign: 'center', background: '#fff', borderRadius: 12, border: '1px dashed #cbd5e1', marginTop: 20 }}>
          <p style={{ color: '#64748b', fontWeight: 600 }}>Not enough longitudinal data to calculate trends yet.</p>
        </div>
      ) : (
        <>
